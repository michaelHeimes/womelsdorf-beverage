<section class="entry-content section-contact-info" itemprop="text">
	<div class="grid-container">
		<div class="grid-x grid-padding-x">
			<div class="left cell small-12 medium-6 tablet-4 tablet-offset-1">
				<ul class="menu contact-info vertical">
					<li>
				...
				<ul class="menu social">
					<li>
						<a href="<?php the_field('facebook_url', 'option');?>" target="_blank">
							<svg xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 6.185 12.369" id="" class="style-svg replaced-svg svg-replaced-0">
							  <path id="Path_8" data-name="Path 8" d="M137.045,2.054h1.129V.087A14.584,14.584,0,0,0,136.529,0a2.611,2.611,0,0,0-2.743,2.906V4.638h-1.8v2.2h1.8v5.532h2.2V6.837h1.724l.274-2.2h-2V3.124c0-.635.172-1.07,1.057-1.07Z" transform="translate(-131.989)" fill="#fff"></path>
							</svg>
						</a>
					</li>
					<li>
						<a href="<?php the_field('instagram_url', 'option');?>" target="_blank">
							<svg id="" data-name="Group 6" xmlns="http://www.w3.org/2000/svg" height="16" viewBox="0 0 12.541 12.543" class="style-svg replaced-svg svg-replaced-1">
						  		<g id="Group_5" data-name="Group 5" transform="translate(0 0)">
									...
									<path id="Path_6" data-name="Path 6" d="M128.4,124.281a3.222,3.222,0,1,0,3.222,3.222A3.223,3.223,0,0,0,128.4,124.281Zm0,5.312a2.09,2.09,0,1,1,2.09-2.09A2.09,2.09,0,0,1,128.4,129.593Z" transform="translate(-122.128 -121.23)" fill="#fff"></path>
									<path id="Path_7" data-name="Path 7" d="M363.766,89.2a.752.752,0,1,1-.752-.752A.752.752,0,0,1,363.766,89.2Z" transform="translate(-353.391 -86.275)" fill="#fff"></path>
						  		</g>
							</svg>
						</a>
					</li>
			...
			<div class="right cell small-12 medium-6 tablet-6">
				<div style="width: 100%"><iframe width="100%" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=440%20N%203rd%20St,%20Womelsdorf,%20PA%2019567+(Womelsdorf%20Beverage)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></div>
			</div>						
		</div>
	</div>
</section>